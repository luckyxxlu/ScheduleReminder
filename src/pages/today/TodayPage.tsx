...
export function TodayPage() {
  const [status, setStatus] = useState<'宽容中' | '已完成' | '已跳过'>('宽容中')
      ...
      <div className="page-grid page-grid-two">
        <article className="panel panel-hero">
          ...
          <div className="action-row">
            <button className="secondary-button" type="button" onClick={() => setStatus('已完成')}>
              完成
            </button>
        ...
        <article className="panel">
          ...
          <div className="status-block">
            ...
            <strong className={`status-chip status-${status}`}>{status}</strong>
          </div>
        </article>
      </div>
    </section>
